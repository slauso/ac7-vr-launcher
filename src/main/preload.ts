...
const api: AC7Api = {
  ...
  injectUEVR: () => ipcRenderer.invoke('uevr:inject'),
  updateUEVR: () => ipcRenderer.invoke('uevr:update'),
  importUEVRFolder: () => ipcRenderer.invoke('uevr:importFolder'),
  deployUEVRProfile: () => ipcRenderer.invoke('uevr:deployProfile'),
  getUEVRRuntimeOptions: () => ipcRenderer.invoke('uevr:runtimeOptions:get'),
  setUEVRRuntimeOptions: (options) => ipcRenderer.invoke('uevr:runtimeOptions:set', options),
  ...
  readSettings: () => ipcRenderer.invoke('settings:get'),
  writeSettings: (settings: AppSettings) => ipcRenderer.invoke('settings:save', settings),
  browseForModFile: () => ipcRenderer.invoke('dialog:browseModFile'),
  listMods: () => ipcRenderer.invoke('mods:list'),
  enableMod: (fileName: string) => ipcRenderer.invoke('mods:enable', fileName),
  disableMod: (fileName: string) => ipcRenderer.invoke('mods:disable', fileName),
  installModFromPath: (sourcePath: string) => ipcRenderer.invoke('mods:install', sourcePath),
  uninstallMod: (fileName: string) => ipcRenderer.invoke('mods:uninstall', fileName),
  getCameraPresets: () => ipcRenderer.invoke('camera:getPresets'),
  setCameraPreset: (preset) => ipcRenderer.invoke('camera:setPreset', preset),
